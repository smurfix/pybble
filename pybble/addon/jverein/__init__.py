...
""" % (self.accountdb,self.accountnr)
	...
	def html_edit(self):
		...
		return render_template('jverein/edit_acct.html', obj=self, form=form, name=self.parent.name, title_trace=[self.name,"Verein","Konto"])
	...
	def html_new(cls,parent,name=None):
		...
		return render_template('jverein/new_acct.html', parent=parent, form=form, name=parent.name, title_trace=["neu","Verein","Konto"])
